            ...
            HStack(content: {
                VStack(alignment: .leading, content: {
                    HStack(alignment: .top) {
                        ...
                        //TODO: need location decoding here
                        Text("Thaikkatil house, Vellanikkara, Thrissur")
                    ...
                    if let thingsTodo = wishlistedLocation.thingsToDo {
                        Text("Things to do :-")
...
#Preview {
    ...
    var location = vm.addWishlistedLocation(title: "Paulettans Pizzeria", category: cat)
    
    location.setLocation(lattitude: 10.516687, longitude: 76.225437)
